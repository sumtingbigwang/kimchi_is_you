...
eqDict = {'equals': [(4,1),(4,10),(10,1),(12,1),(12,10),(11,11)]}
...
subjDict = {'wallword': [(9,1),(11,10),(13,1)],
               'rockword': [(11,1)],
               'babaword': [(3,1)],
               'flagword': [(3,10)]}
...
level = level(69,levelDict,(17,13),rgb(21,24,31), 'black', 30) #store the size of the level here.
